...
VENDAS_COL_DATA = "DataCaptacao"          # xlsx: '2026-08-25T00:00:00.000' · CSV: '25/08/2026 00:00:00'
VENDAS_COL_DATA_ISO = "DataCaptacao_ISO"  # derivada no upload: 'AAAA-MM-DD' (recorte "hoje" da meta diária)

VENDAS_OPTIONAL_COLUMNS = [VENDAS_COL_MEIO_CAPTACAO, VENDAS_COL_GERENCIA, VENDAS_COL_DATA]
